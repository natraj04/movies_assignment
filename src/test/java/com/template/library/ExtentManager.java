...
public class ExtentManager {
    ...
    public static String reportFileName = "Automation-Report"+"_" + new SimpleDateFormat("yyyy-MM-dd hh-mm-ss-ms").format(new Date()) + ".html";
    ...
    private static String getReportFileLocation (Platform platform) {
        ...
        switch (platform) {
            ...
            case UNIX:
                reportFileLocation = macReportFileLoc;
                createReportPath(macPath);
                System.out.println("ExtentReport Path for UNIX: " + macPath + "\n");
                break;
